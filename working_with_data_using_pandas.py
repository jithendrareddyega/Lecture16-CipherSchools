# -*- coding: utf-8 -*-
"""Working With Data Using Pandas.ipynb

Automatically generated by Colab.

Original file is located at
    https://colab.research.google.com/drive/1itcgemNcjJF2L4l-NndUpH2pew0fKZYc

# Working with data using pandas
Definition: Pandas is a powerful and flexible open-source data analysis and manipulation library for python provides data structures like Series(One-dimensional) and DataFrame(Two-dimensional) that are efficient for handling large datasets. Pandas allows for manipulation, aggregation and merging.
"""
